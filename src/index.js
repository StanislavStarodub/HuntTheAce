...
function gameOver() {
  ...
  playGameButtonElem.disable = false
}
...
function initializeNewRound() {
  roundNum++
  playGameButtonElem.disable = true
...
function collectCards() {
  ...
  addCardsToGridAreasCell(cardCollectionCellClass)
}
...
function addCardsToGridAreasCell(cellPositionClassName) {
...
function createCard(cardItem) {
  ...
  // assing class to back image element of back of card
  addClassToElement(cardBackImg, 'card-img')

  // assing class to front image element of front of card
  ...
  // add card element as a child element to appropriate grid cell
...
function updateGameObjet(score, round) {
